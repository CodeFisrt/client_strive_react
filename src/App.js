...
import GetPayProID from './pages/Payments/GetPayProID';
import AddPaymets from './pages/Payments/AddPaymets';
    ...
    <div>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path='AddPayments' element={<AddPaymets></AddPaymets>}></Route>
        </Routes>
